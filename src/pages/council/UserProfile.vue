      ...
      <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
        <q-card class="card-bg text-white no-shadow" bordered>
          <q-card-section class="text-center bg-transparent">
            ...
            <div class="text-subtitle2 q-mt-lg">software industry</div>
            <div class="text-h6 q-mt-md">Technokeens</div>
          </q-card-section>
          <q-card-section>
            <div class="text-body2 text-justify">
              At the forefront of innovative technology, we specialize in custom
              IT solutions. Our team of committed professionals is adept at
              converting distinct challenges into personalized action plans. We
              excel at creating specialized solutions that align with your
              objectives, ensuring maximum results.
            </div>
          </q-card-section>
        </q-card>
      </div>
