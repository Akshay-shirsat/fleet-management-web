        ...
        <div class="q-pa-md example-row-equal-width">
            <div class="row mb-block header_block">
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 q-pa-sm">
                    ...
                    <div class="text-title"><q-icon name="arrow_back_ios" class="q-mt-none" style="margin-top: -8px;" /> Defects Reported</div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 q-pa-sm filter_block q-my-auto">
                    ...
                    <q-btn icon="add" color="primary" class="q-mx-sm q-px-md text-capitalize filterbtn_right"> <span class="q-pl-xs" to="/add-vehicle">Add Vehicle</span> </q-btn>
            ...
            <q-table
                ...
                <template v-slot:body-cell-details="props">
                    <q-td :props="props">
                        <div flat class="text-blue text-capitalize cursor-pointer" @click="$router.replace('/view-defects')">
                            {{ props.row.details }}
                        </div>
                    </q-td>
                </template>
...
var columns = [
  ...
  { name: 'defectscount', align: 'left', label: 'Defects', field: 'defectscount'},
...
export default defineComponent({
  ...
  setup() {
    useMeta(() => {
      return {
        title: "Defects List - Fleet Management",
      };
    });
  },
  data(){
