    ...
    <div class="q-pa-md example-row-equal-width">
      <div class="row mb-block header_block">
        <div class="col-lg-4 col-md-4 col-sm-12 q-pa-sm">
          <small>
            <q-breadcrumbs>
              ...
              />
              <q-breadcrumbs-el label="Accident Report Details" />
            </q-breadcrumbs>
          </small>
        ...
        >
          ...
          >
            <span class="q-pl-xs">Request Update</span>
          </q-btn>
          <q-input
            dense
            filled
      ...
      <div class="row mb-block q-my-sm">
        ...
        <div
          ...
          v-if="isdataAvailable"
        >
          <q-splitter v-model="splitterModel" style="height: 560px" class="">
            <template v-slot:before>
              <q-tabs
                v-model="tab"
                vertical
              ...
              >
                <q-tab
                  name="injuries"
                  label="Injuries"
                  class="text-capitalize borderbottom tabboderbottom"
                />
                <q-tab
                  name="location"
              ...
              >
                <q-tab-panel name="injuries" class="no-padding">
                  <div class="row q-pl-sm">
                    <div
                      class="col-lg-12 col-md-12 col-sm-12 col-xs-12 horiz-tabsborder q-pa-md q-mb-md"
                    >
                  ...
                  <div class="row q-pl-sm">
                    ...
                    >
                      <div class="text-body2">
                        1. Is your vehicle drivable?*
                      </div>
                      <div class="q-pl-sm q-mt-md">
                        <q-btn
                          outline
                          class="themebtnborder q-mx-sm q-px-lg btnactive_blue"
                        >
                          Yes
                        </q-btn>
                        <q-btn outline class="themebtnborder q-mr-sm q-px-lg">
                          No
                        </q-btn>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div class="q-pl-sm q-mt-md">
                        <q-btn outline class="themebtnborder q-mx-sm q-px-lg">
                          2
                        </q-btn>
                      </div>
                    </div>
                    ...
                    >
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div class="text-body2">
                            3. Tap on the image below to indicate where your
                            vehicle has been damaged. You can select multiple
                            area
                          </div>
                          <div class="q-pl-sm q-mt-md">
                            <q-img
                    ...
                    >
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div class="text-body2">
                            4. Photos of damage to Vehicle 1
                          </div>
                          <div class="q-pl-sm q-mt-md">
                            <q-img
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div class="text-body2">
                            5. Photos of damage to Vehicle 2
                          </div>
                          <div class="q-pl-sm q-mt-md">
                            <q-img
                              src="~src/assets/images/a1.png"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          <div class="text-body2">
                            6. Photos of damage to Vehicle 3
                          </div>
                          <div class="q-pl-sm q-mt-md">
                            <q-img
                              src="~src/assets/images/a2.png"
...
export default defineComponent({
  name: "AccidentRDetails",
  components: {},
  setup() {
    useMeta(() => {
      return {
        title: "Accident Details - Fleet Management",
      };
    });
  },
  data() {
