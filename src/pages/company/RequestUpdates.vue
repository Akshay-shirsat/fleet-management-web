        ...
        <div class="q-pa-md example-row-equal-width">
            <div class="row mb-block header_block">
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 q-pa-sm">
                    <small>
                        <q-breadcrumbs>
                            ...
                            <q-breadcrumbs-el label="Request Updates" />
                        </q-breadcrumbs>
                    </small>
                    <div class="text-title">Request Updates</div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 q-pa-sm filter_block q-my-auto">
                    ...
                    <q-btn icon="add" color="primary" class="q-mx-sm q-px-md text-capitalize filterbtn_right" to="/new-request"> <span class="q-pl-xs">Create Request</span> </q-btn>
            ...
            <q-table
                ...
                <!-- <template v-slot:body-cell-status="props">
                    <q-td :props="props">
                        <div flat class="text-blue text-capitalize cursor-pointer" @click="$router.replace('/vehicle-registered-action')">
                            {{ props.row.status }}
                        </div>
                    </q-td>
                </template> -->
                ...
                <template v-slot:body-cell-action="props">
                    <q-td :props="props">
                        ...
                        <q-icon name="delete" size="20px" class="q-pr-sm" color="red" />
                    </q-td>
                </template>
            </q-table>
            <!-- TABLE VIEW END -->
...
export default defineComponent({
    ...
    setup() {
        useMeta(() => {
            return {
                title: "Request Updates - Fleet Management",
            };
        });
    },
    data(){
