        ...
        >
          ...
          <q-tab-panels v-model="tab" animated class="q-mt-md">
            <q-tab-panel name="info_tab" class="no-padding">
              <q-form @submit="updateDriverDetails" class="q-gutter-md">
                <div class="row tabsborder">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 q-pa-sm">
                    ...
                    <div class="row q-pa-sm">
                      ...
                      >
                        <label class="custom-label"
                          >DBS Update Certificate No.</label
                        >
                        <q-input
                          outlined
                          name="certificate"
  ...
  methods: {
    ...
    async getDriverDetails() {
      try {
        ...
        const response = await api.get(`/getDriverDetails/${driverId}`, config);

        if (response.status === 200) {
          Loading.hide();
          this.driver_fullname = response.data.driverDetails.driverFullName;
          this.email_id = response.data.driverDetails.emailId;
          this.app_id = response.data.driverDetails.app_id;
          // this.password = response.data.driverDetails.password;
          this.phone_number = response.data.driverDetails.phoneNo;
          this.date_OfBirth = response.data.driverDetails.dateOfBirth;
          this.address = response.data.driverDetails.address;
          this.national_insurance =
            response.data.driverDetails.nationalInsuranceNo;
          this.council_badge = response.data.driverDetails.councilBadgeUpload;
          this.licence = response.data.driverDetails.dVLADrivingLicenceNo;
          this.certificate = response.data.driverDetails.dBSUpdateCertificateNo;
        }
      } catch (error) {
        Loading.hide();
