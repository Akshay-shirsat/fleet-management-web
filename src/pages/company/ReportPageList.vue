        ...
        <div class="q-pa-md example-row-equal-width">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="text-h6">All Reports</div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 q-pa-sm filter_block  q-my-auto">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 q-pa-sm">
                    <q-btn-dropdown dense outline color="primary" class="text-capitalize" label="Last Weekly" style="width:100%">
                        <q-list>
                        <q-item clickable v-close-popup>
                            <q-item-section>
                            <q-item-label>Last Weekly</q-item-label>
                            </q-item-section>
                        </q-item>
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 q-pa-sm text-center">
                    <q-btn-group outline color="blue" class="text-capitalize ">
                        <q-btn dense outline color="blue" label="Day" class="text-capitalize q-px-sm" />
                        <q-btn dense outline color="blue" label="Week" active class="text-capitalize q-px-sm" />
                        <q-btn dense outline color="blue" label="Month" class="text-capitalize q-px-sm" />
                    </q-btn-group>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 q-pa-sm">
            ...
            <q-table
                ...
                <template v-slot:body-cell-status="props">
                    <q-td :props="props">
                        <span class="text-green-9" v-if="props.row.status == 'Completed'"> {{props.row.status}}</span>
                        <span class="text-red-9" v-if="props.row.status == 'In-Progress'"> {{props.row.status}}</span>
                    </q-td>
                </template>
                <template v-slot:body-cell-defects="props">
                    <q-td :props="props">
                        <span class="text-red-9" v-if="props.row.defects == '5 Defect'"> {{props.row.defects}}</span>
                    </q-td>
                </template>
                <template v-slot:body-cell-details="props">
                    <q-td :props="props">
                        <div flat class="text-blue text-capitalize cursor-pointer" @click="$router.replace('/view-business')">
                            {{ props.row.details }}
                        </div>
                    </q-td>
                </template>
