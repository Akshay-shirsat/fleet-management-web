        ...
        <div class="q-pa-md example-row-equal-width">
            <div class="row mb-block header_block">
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 q-pa-sm">
                    <small>
                        <q-breadcrumbs>
                            ...
                            <q-breadcrumbs-el to="/defects-reported-list" label="Defects Reported" />
                            <q-breadcrumbs-el label="Defects details" />
                        </q-breadcrumbs>
                    </small>
                    <div class="text-title"><q-icon name="arrow_back_ios" class="q-mt-none" style="margin-top: -8px;" /> Defects: HVI10412</div>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 q-pa-sm filter_block q-my-auto">
                    ...
                    <q-btn color="primary" class="q-mx-sm q-px-md text-capitalize filterbtn_right" to="/add-business"> <span class="q-pl-xs">Request update</span> </q-btn>
...
export default defineComponent({
    ...
    setup() {
        useMeta(() => {
            return {
                title: "Defects Detail Report - Fleet Management",
            };
        });
    },
    data(){
