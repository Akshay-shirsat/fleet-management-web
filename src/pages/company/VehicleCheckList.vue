        ...
        <div class="q-pa-md example-row-equal-width">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 q-pa-sm">
                    <small>
                        <q-breadcrumbs>
                            ...
                            <q-breadcrumbs-el label="Vehicle Checks" />
                        </q-breadcrumbs>
                    </small>
                    <div class="text-title"><q-icon name="arrow_back_ios" class="q-mt-none" style="margin-top: -8px;" />Vehicle Checks</div>
            ...
            <q-table
                ...
                <template v-slot:body-cell-details="props">
                    <q-td :props="props">
                        <div flat class="text-blue text-capitalize cursor-pointer" @click="$router.replace('/vehicle-check-details')">
                            {{ props.row.details }}
                        </div>
                    </q-td>
                </template>
