        ...
        <div class="q-pa-md example-row-equal-width">
            <div class="row mb-block header_block">
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 q-pa-sm">
                    <small>
                        <q-breadcrumbs>
                            ...
                            <q-breadcrumbs-el to="/vehicle-check-list" label="Vehicle Checks" />
                            <q-breadcrumbs-el label="Vehicle Check Details" />
                        </q-breadcrumbs>
                    </small>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 q-pa-sm filter_block q-my-auto">
                    ...
                    <q-btn color="primary" class="q-mx-sm q-px-md text-capitalize filterbtn_right" to="/request-updates"> <span class="q-pl-xs">Request update</span> </q-btn>
                ...
                <!-- <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 q-pa-sm q-my-auto text-right">
                    ...
                    <q-btn flat dense icon="download" class="q-mx-xs"> <span class="q-pl-xs">Export</span> </q-btn>
                </div> -->
            </div>
...
export default defineComponent({
    ...
    setup() {
        useMeta(() => {
            return {
                title: "Check Details - Fleet Management",
            };
        });
    },
    data(){
