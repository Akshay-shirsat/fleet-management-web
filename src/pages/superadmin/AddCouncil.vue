        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 q-pa-sm">
          <small
            ><q-breadcrumbs>
              ...
              <q-breadcrumbs-el label="Add Council" /> </q-breadcrumbs
          ></small>
          ...
          <div class="text-weight-light header-sub-title" style="color: #7c8db5">
            Here is the information about all Councils
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" v-if="activeSkeleton">
          ...
          <q-tab-panels v-model="tab" animated class="q-mt-md">
            <q-tab-panel name="add_vehicle_tab" class="no-padding">
              <q-form @submit="saveNewCouncilRecord" class="q-gutter-md" greedy>
                <div class="row tabsborder">
                  <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 q-pa-sm">
                    ...
                    >
                      <q-img src="~src/assets/images/blank_profile.png"></q-img>
                      <q-file
                        dense
                        flat
                        rounded
                  ...
                  <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 q-pa-sm">
                    <div class="row q-pa-sm">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 q-pa-md">
                        <label class="custom-label">Names of Council Staff</label>
                        <q-input
                          outlined
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 q-pa-md">
                        <label class="custom-label">Contact email address</label>
                        <q-input
                          type="email"
                          outlined
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 q-pa-md">
                        <label class="custom-label">Address of Head Office</label>
                        <q-input
                          type="textarea"
                          outlined
                          v-model="address"
  ...
  methods: {
    async saveNewCouncilRecord() {
      ...
      try {
        ...
        await api
          .post("/saveNewCouncilRecord", formData, config)
          .then(function (response) {
            if (response.status == 200) {
              ...
              Notify.create({
                color: "green-5",
                textColor: "white",
                message: "Council added successfully",
                icon: "check",
              });
