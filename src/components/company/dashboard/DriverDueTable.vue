    ...
    <q-card class="my-card q-pa-md" style="min-height:390px" v-if="activeComp == ''">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 q-pa-sm">
                <div class="">Drivers Due Dates</div>
            </div>
    ...
    <q-card bordered class="my-card no-shadow q-pa-md" v-if="activeComp">
        ...
        >
            ...
            <template v-slot:body-cell-date="props">
                <q-td :props="props">
                    <div flat class="text-red text-capitalize cursor-pointer" v-if="props.row.due='Yes'">
                        <span>{{ props.row.date }} <q-icon name="calendar_month" style="margin-top: -6px;" class="q-pl-sm" /></span>
                    </div>
                </q-td>
            </template>
            <template v-slot:body-cell-school_expiry="props">
                <q-td :props="props">
                    <div flat class="text-capitalize cursor-pointer">
                        <span>{{ props.row.school_expiry }} <q-icon name="calendar_month" style="margin-top: -6px;" class="q-pl-sm" /></span>
                    </div>
                </q-td>
            </template>
            <template v-slot:body-cell-licence_expiry="props">
                <q-td :props="props">
                    <div flat class="text-capitalize cursor-pointer">
                        <span>{{ props.row.licence_expiry }} <q-icon name="calendar_month" style="margin-top: -6px;" class="q-pl-sm" /></span>
                    </div>
                </q-td>
            </template>
...
var columns = [
  ...
  { name: 'mobile_no', align: 'left', label: 'Mobile No.', field: 'mobile_no', sortable: true },
  { name: 'council_expiry', align: 'left', label: 'Council Badge Expiry Date', field: 'council_expiry', sortable: true },
  { name: 'school_expiry', align: 'left', label: 'School Badge Expiry Date', field: 'school_expiry' },
  { name: 'licence_expiry', align: 'left', label: 'DVLA Driving Licence Expiry', field: 'licence_expiry' },
  { name: 'date', align: 'left', label: '-', field: 'date' },
]
...
var rows = [
  {
    ...
    driver: 'Driver Name',
    mobile_no : 'cell',
    council_expiry: '27/01/2023',
    school_expiry: '27/01/2023',
    licence_expiry: '27/01/2023',
    date : '27/01/2023',
  },
  {
    id:'2',
